export const settingsCopy = {
  ...
  'settings.macro.preset': 'Quick preset',
  'settings.macro.preset.moreCarbs': 'More carbs',
  'settings.macro.preset.balanced': 'Balanced',
  'settings.macro.preset.moreProtein': 'More protein',
