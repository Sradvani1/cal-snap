# CalSnap Web — Historical Master Review & Improvement Plan

> **Historical archive:** This superseded review plan records the WR sprint. It contains time-bound assumptions, including the removed Playwright and middleware work.
...
**Historical indexes:** [plans README](./README.md) · **Rollout record:** [ROLLOUT.md](../build/ROLLOUT.md)
...
Individual planning phases produce `docs/build/PR-WR0N.md` and `.cursor/plans/pr_wr0N_*.plan.md`.
...
| Artifact | Path |
|----------|------|
| Master plan | `docs/build/REVIEW-MASTER-PLAN.md` |
| Per-PR spec | `docs/build/PR-WR01.md` … `PR-WR08.md` |
