...
| `docs/build/PERF-BASELINE.md` (new) | Lighthouse baseline doc | WO05 deliverable |
| `docs/build/OPTIMIZATION-MASTER-PLAN.md` (new) | Sprint close-out | WO05 deliverable |
...
- `docs/build/PR-WO05.md`
- `docs/build/PERF-BASELINE.md`
- `docs/build/OPTIMIZATION-MASTER-PLAN.md`
