...
**Status:** Implemented  
**Historical source references:** [`archive/ios/docs/technical-spec.md`](../../archive/ios/docs/technical-spec.md) (Global Constants, NutritionCalculator, models), [`archive/ios/docs/engineering-rules.md`](../../archive/ios/docs/engineering-rules.md), [`.cursor/plans/calsnap_web_prs_4a5e9349.plan.md`](../../../.cursor/plans/calsnap_web_prs_4a5e9349.plan.md)
...
| `docs/build/README.md` | Web stack summary + open decisions |
| `docs/build/PR-W01.md` | This checklist |
...
| Web implementation docs | `docs/build/` |
...
- [x] `docs/build/README.md` + `PR-W01.md`
